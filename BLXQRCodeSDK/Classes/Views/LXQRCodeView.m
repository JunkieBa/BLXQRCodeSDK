...
- (void)initUiConfig {
    ...
    UIImageView *leftTop = [[UIImageView alloc] initWithImage:[UIImage lx_imageNamed:@"shapeLeftTopIcon"]];
    ...
    UIImageView *leftBottom = [[UIImageView alloc] initWithImage:[UIImage lx_imageNamed:@"shapeLeftBottomIcon"]];
    ...
    UIImageView *rightTop = [[UIImageView alloc] initWithImage:[UIImage lx_imageNamed:@"shapeRightTopIcon"]];
    ...
    UIImageView *rightBottom = [[UIImageView alloc] initWithImage:[UIImage lx_imageNamed:@"shapeRightBottomIcon"]];
    ...
    _lineImageView.image = [UIImage lx_imageNamed:@"RectangleLineIcon"];
    ...
    UIImage *flashImage = [UIImage lx_imageNamed:@"turnOffFlashLightIcon"];
    _flashlightButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [_flashlightButton setImage:[UIImage lx_imageNamed:@"turnOffFlashLightIcon"] forState:UIControlStateNormal];
    [_flashlightButton setImage:[UIImage lx_imageNamed:@"turnOnFlashLightIcon"] forState:UIControlStateSelected];
