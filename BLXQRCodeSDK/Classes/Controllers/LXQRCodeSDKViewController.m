...
@interface LXQRCodeSDKViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIImage *leftNormalImage = [UIImage lx_imageNamed:@"icon-back"];
